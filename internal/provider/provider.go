...
import (
	...
	source_datasource "github.com/AnasSahel/terraform-provider-sailpoint-isc-community/internal/provider/services/source/datasource"
	source_resource "github.com/AnasSahel/terraform-provider-sailpoint-isc-community/internal/provider/services/source/resource"
...
func (p *sailpointProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		source_datasource.NewSourceDataSource,
		source_datasource.NewSourcesDataSource,
...
func (p *sailpointProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		source_resource.NewSourceResource,
