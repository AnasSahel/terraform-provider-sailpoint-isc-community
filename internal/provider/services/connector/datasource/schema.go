	...
	return datasource_schema.Schema{
		...
		Attributes: map[string]datasource_schema.Attribute{
			...
			"filters": datasource_schema.StringAttribute{
				Description:         "Filter results using the standard syntax. Supported filters: name (sw, co), type (sw, co, eq), directConnect (eq), features (ca).",
				MarkdownDescription: "Filter results using the standard syntax. Supported filters: `name` (sw, co), `type` (sw, co, eq), `directConnect` (eq), `features` (ca).",
				Optional:            true,
			},
				...
				NestedObject: datasource_schema.NestedAttributeObject{
					Attributes: map[string]datasource_schema.Attribute{
						...
						"status": datasource_schema.StringAttribute{
							Description:         "The status of the connector. Possible values: 'RELEASED', 'DEVELOPMENT', 'DEMO', 'DEPRECATED'.",
							MarkdownDescription: "The status of the connector. Possible values: `RELEASED`, `DEVELOPMENT`, `DEMO`, `DEPRECATED`.",
							Computed:            true,
						},
