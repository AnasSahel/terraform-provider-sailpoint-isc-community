...
{{tffile "examples/resources/sailpoint_source_schema/main.tf"}}
...
```shell
# Source schemas can be imported using the format: source_id/schema_id
terraform import sailpoint_source_schema.example 000000000000000000000000000000000000/000000000000000000000000000000000000
```
